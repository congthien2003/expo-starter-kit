						...
						<View className="p-4">
							...
							<View className="gap-3 mb-4">
								...
								<Button
									variant="destructive"
									onPress={() =>
										handlePress("Destructive Button")
									}>
									Destructive Button
								</Button>
							</View>
							...
							<View className="gap-3 mb-4">
								<Button
									...
									variant="primary"
									onPress={() =>
										router.push("/(tabs)/demo-home")
									}>
									Small Button Demo Home
								</Button>
								<Button
									size="md"
									variant="primary"
									onPress={() =>
										router.push("/(tabs)/demo-login")
									}>
									Medium Button Demo Login
								</Button>
					...
					<Card variant="outlined" className="mb-6">
						<View className="p-4">
							...
							<EmptyState
								...
								onAction={() =>
									handlePress("Empty State Action")
								}
							/>
						</View>
					</Card>
					...
					<Card variant="outlined" className="mb-6">
						<View className="p-4">
							...
							<Collapsible title="Click to expand">
								<View className="mt-2">
									<Body>
										This content is hidden by default and
										shows when you click the header.
									</Body>
								</View>
							</Collapsible>
							<Spacer size="md" />
